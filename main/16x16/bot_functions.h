...
int* minimum_cost_fast_run(short int arena_map[16][16], short int bot_pos[2], int *sortedArray_fast_run);
...
int minimum_value_accessible_neighbors_fast_run(short int arena_map[16][16], short int pos[2], int *smallest_accessible_regardless_fast_run,bool wall_data[][16][4]);
...
int direction_wrt_compass_fast_run(short int arena_map[16][16], short int bot_pos[2], bool wall_data[][16][4]);
int direction_wrt_compass(short int arena_map[16][16], short int bot_pos[2],bool wall_data[][16][4]);
int direction_wrt_bot_fast_run(short int arena_map[16][16], short int bot_pos[2], int fast_run_facing, bool wall_data[][16][4]);
